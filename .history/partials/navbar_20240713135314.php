<nav>
  <ul>
      ...
      <li id="lightbulbContainer">
        <svg xmlns="http://www.w3.org/2000/svg" id="pullCord" width="100" height="500" viewBox="0 0 100 500">
            <g transform="translate(50,0)">
              <line x1="0" y1="0" x2="0" y2="200"/>
              <circle cx="0" cy="200" r="5" />
              
            </g>
            <text x="-10" y="200" font-size="2">🕷️</text>
        </svg>
        <svg height="40" width="200" xmlns="http://www.w3.org/2000/svg">
        <text x="5" y="30" fill="none" stroke="red" font-size="2">I love SVG!</text></svg>
