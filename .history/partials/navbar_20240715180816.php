<nav>
  <ul>
      ...
      <li class="dropdown-list">writing
        <ul>
          <li><a href="/writing/lifeiszoo.php">lifeiszoo</a></li>
        </ul>
      </li>
      <li id="lightbulbContainer">
        <svg xmlns="http://www.w3.org/2000/svg" id="pullCord" width="50" height="300" viewBox="0 0 50 300">
            <g transform="translate(25,0)">
              <line x1="0" y1="0" x2="0" y2="200"/>
              <circle cx="0" cy="200" r="5"/>
              <g transform="scale(1.3)">
                <text x="-10" y="160" id="customPullCordHandle"></text> <!-- Since icon is scaled, y must be scaled too -->
              </g>
            </g>
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" id="lightbulb" width="20" height="20" fill="currentColor" class="bi bi-lightbulb" viewBox="0 0 16 16">
