<nav>
    <ul>
        ...
        <li id="lightbulb">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" height="200" width="300" fill="currentColor">
            <line x1="0" y1="0" x2="300" y2="200" style="stroke:red;stroke-width:2" stroke-dasharray=10 stroke-linecap="round"/>
          </svg>
        </li>
    </ul>
  </nav>
