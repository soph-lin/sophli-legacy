...
function bindEvents() {
    ...
    const dropInfoHeaders = document.querySelectorAll('.dropInfoHeader');
    ...
    if (dropInfoHeaders) {
        dropInfoHeaders.forEach(el => el.addEventListener('click', function(e) {
            ...
            // TODO: update display
            // TODO: only allow clicks on header (maybe change el to click on to drop header instead?)
            const info = el.parentNode.querySelector('dropInfoEntries');
            if (open) {
