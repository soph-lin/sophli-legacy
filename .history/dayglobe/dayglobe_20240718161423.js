class Sun {
    constructor(sunEl, windowEl, updateChangeX, maxTime) {
        this.sunEl = sunEl;
...
function setupDayGlobe() {
    ...
    const updateChangeX = 1; // horizontal change per update, in px
    const sun = new Sun(sunEl, windowEl, updateChangeX, maxTime);
    let t = 0;
