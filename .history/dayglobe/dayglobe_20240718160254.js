class Sun {
    ...
    getHeightFunc(windowEl) { // generate xy parabola in terms of max width and height https://www.desmos.com/calculator/pmkwrgbfkc
        ...
        return (x) => a * x * (x - maxW) + windowHeight; // translate at y = 0 is at top of windowEl, inc y makes element go down
    }
    ...
    moveSun(t) {
        ...
        console.log(x, y);
        this.sunEl.style.transform = `translate(${x - this.sunRadius}px, ${-1 * (y - this.sunRadius)}px)`;
    }
}
