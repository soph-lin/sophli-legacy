...
function getLastWeek() { // Return last week, starting date of Sunday and ending date of Saturday
    ...
    const lastSunday = new Date(today.valueOf()).setDate(today.getDate() - 7 - dayOfWeek); // Last Sunday will be 7 days away minus today' weekday
    const lastSaturday = new Date(lastSunday.valueOf()).setDate();
